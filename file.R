...
#
# 암시적 형 변환 implcit, explcit 숫자와 문자를 함께 쓸 때만, 숫자를 문자로 바꿀수 있지만 문자를 숫자로 바꿀순 없다.
#
class( vector ); class( vector2 ); class( vector3 )
str( vector ); str( vector2 ); ( vector3 )
print( vector ); print( vector2 ); ( vector3 )
